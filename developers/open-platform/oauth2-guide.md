---
url: /developers/open-platform/oauth2-guide.md
...
| **open\_id** | A stable unique identifier for the user within the current third-party app. **Deterministic** (same user + same app = always the same), **irreversible**, **different across apps** |
