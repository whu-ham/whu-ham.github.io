---
url: /guide/mcp/config.md
description: >-
  Ham MCP service configuration guide — Configure Ham MCP in Claude, ChatGPT,
  Cherry Studio, Cursor, Antigravity, Claude Code, Codex, and more.
---
